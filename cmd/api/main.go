...
var adminTemplate = template.Must(template.New("admin").Funcs(template.FuncMap{
	"div": func(cents int64, divisor int64) float64 { return float64(cents) / float64(divisor) },
